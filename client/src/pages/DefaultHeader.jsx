...
const DefaultHeader = () => {
  ...
  return (
    <div className="flex items-center justify-between z-50 h-[50px] fixed w-[100vw] lg:w-[87vw] lg:h-[80px] bg-secondary text-white shadow px-5">
      <div className="lg:!text-3xl text-sm tracking-wider text-primary  lg:mt-0 mt-2">
        Jai Export Enterprises
      </div>
      <div className="flex  gap-x-4 items-center">
        <span className="lg:text-sm text-sm lg:mt-0 lg:block hidden">
          {moment(Date.now()).format("hh:mm:ss A")}
        </span>
        <div className="flex gap-x-2 items-center  lg:!bg-white text-secondary rounded-2xl p-[2px] pl-3 ">
          <div className="uppercase hidden lg:block  !text-sm">
